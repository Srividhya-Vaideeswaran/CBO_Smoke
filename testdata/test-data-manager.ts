...
export class TestDataManager {
  ...
  static loadDataRow(rowNumber: number): ParsedTestData {
    ...
    const parsedData: ParsedTestData = {
      ...
      APIid: row.APIid,
      APIproviderCode: row.APIproviderCode,
      APIproviderName: row.APIproviderName,
      APIreference1: row.APIreference1,
      APIserialNumberOrVIN: row.APIserialNumberOrVIN,
      APImake: row.APImake,
      APImodel: row.APImodel,
      APItrimOrStyle: row.APItrimOrStyle,
      APItype: row.APItype,
      APIyear: row.APIyear,
      APIfirstName: row.APIfirstName,
      APIlastName: row.APIlastName,
      APIdateOfBirth: row.APIdateOfBirth,   
      APIaddressType: row.APIaddressType,
      APIaddress: row.APIaddress,
      APIcity: row.APIcity,
      APIjurisdiction: row.APIjurisdiction,
      APIpostalOrZipCode: row.APIpostalOrZipCode,
      APIcountry: row.APIcountry,
      APIcmsLenderCode: row.APIcmsLenderCode,
      APIproviderLenderName: row.APIproviderLenderName,
      APIapplicationType: row.APIapplicationType,
      APIloanType: row.APIloanType
    };
